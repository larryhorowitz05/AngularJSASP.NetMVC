...
{
    public class CommandsBaseUserFilter : ICommand
    {
        #region # Private
        ...
        public System.Web.WebPages.Html.SelectListItem ViewAllItemGuid = new System.Web.WebPages.Html.SelectListItem()
        {
            Text = "View All",
