...
{
    public class ContactStatusFilterCommand : ICommand
    {
        ...
        public void Execute()
        {
            ...
            if ( !InputParameters.ContainsKey( "StatusFilter" ) )
                throw new ArgumentException( "StatusFilter was expected!" );

            Int32 contactStatus = -1;
            Int32.TryParse(InputParameters["StatusFilter"].ToString(), out contactStatus);
            contactListState.ContactStatusFilter = contactStatus;
