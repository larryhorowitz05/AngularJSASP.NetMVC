...
{
    public class NewLoanApplicationGridDateFilterCommand : ICommand
    {
        ...
        public void Execute()
        {
            ...
            if (!InputParameters.ContainsKey("DateFilter"))
                ...
                newDateFilterValue = ( GridDateFilter )Enum.Parse( typeof(GridDateFilter ), InputParameters[ "DateFilter" ].ToString() );

            newLoanApplicationListState.BoundDate = newDateFilterValue;
