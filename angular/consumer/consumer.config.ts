            ...
            this.$stateProvider.state("docusign",
                {
                    ...
                    resolve: {
                        authenticationContext: function (docusignSVC: IDocusignService, $q: ng.IQService): any {
                            var authenticationContext = docusignSVC.getAuthenticationContext();
                            return authenticationContext;
                        },
                        loanViewModel: function (docusignSVC: IDocusignService, $q: ng.IQService): any {
...
var app = angular.module('docusign').config(
...
app.run(["$rootScope", "$state", "docusignSVC", function ($rootScope: ng.IRootScopeService, $state: ng.ui.IStateService, docusignSVC: docusign.IDocusignService) {
