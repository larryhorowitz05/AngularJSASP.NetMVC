module loancenter {
    ...
    export class transactionSection {
        ...
        private atttachGetterForCost;
        private costGetterFunction;
        public replace;

        constructor(TransactionalSummaryService, private BroadcastSvc) {
            this.restrict = 'E';
            this.replace = true;
            ...
            this.controller = ($scope) => {
                this.atttachGetterForCost($scope.subSection.subSectionList, $scope);
                $scope.calculateSectionTotal = () => {
                    $scope.sectionTotal = this.calculateTotal($scope.subSection.subSectionList)
                }
                $scope.calculateSectionTotal();
        ...
        public static Factory() {
            var directive = (TransactionalSummaryService, BroadcastSvc) => {
