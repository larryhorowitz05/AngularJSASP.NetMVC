...
(function (fha) {
    ...
    (function (controller) {
        var PurchaseController = (function () {
            function PurchaseController(wrappedLoan, fhaCenterService, commonModalWindowFactory, modalWindowType) {
                var _this = this;
            ...
            PurchaseController.$inject = ['wrappedLoan', 'fhaCenterService', 'commonModalWindowFactory', 'modalWindowType'];
            return PurchaseController;
        })();
        angular.module('fhaCenter').controller('purchaseController', PurchaseController);
