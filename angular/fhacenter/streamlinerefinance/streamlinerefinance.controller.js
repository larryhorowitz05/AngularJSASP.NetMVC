...
(function (fha) {
    var controller;
    (function (controller) {
        var StreamlineRefinanceController = (function () {
            function StreamlineRefinanceController(wrappedLoan, fhaCenterService, commonModalWindowFactory, modalWindowType) {
                var _this = this;
                ...
                */
                this.isPrimaryResidence = function () {
                    return _this.wrappedLoan.ref.primary.occupancyType == 1 /* PrimaryResidence */;
                };
                this.calculateFHAFields();
            }
            StreamlineRefinanceController.$inject = ['wrappedLoan', 'fhaCenterService', 'commonModalWindowFactory', 'modalWindowType'];
            return StreamlineRefinanceController;
        })();
...
//# sourceMappingURL=streamlinerefinance.controller.js.map