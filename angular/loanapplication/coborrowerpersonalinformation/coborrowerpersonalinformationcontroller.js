(function () {
    ...
    angular.module('loanApplication')
        .controller('coborrowerpersonalinformationController', coborrowerpersonalinformationController);
    ...
    function coborrowerpersonalinformationController($log, $scope, $modal, assetsSvc, modalPopoverFactory, BroadcastSvc, simpleModalWindowFactory, wrappedLoan, $filter, applicationData) {
        var vm = this;
        var event = {};
        event.type = 'click';
