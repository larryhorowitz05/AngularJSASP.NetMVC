...
(function (loancenter) {
    'use strict';
    function attachParticipantsViewModel(wrappedLoan) {
    ...
    loancenter.attachParticipantsViewModel = attachParticipantsViewModel;
    ...
    function getCompanyTypeLookups() {
    ...
    loancenter.getCompanyTypeLookups = getCompanyTypeLookups;
    ...
    function getPhoneNumber(typeOfNumber) {
        if (typeOfNumber === void 0) { typeOfNumber = null; }
        var types = [
            'Other',
            'Home',
            'Mobile',
        ...
        var p = getPreFix(), s = getSuffix(), a = getAreaCode();
        return {
            areaCode: a,
            preFix: p,
            suffix: s,
    ...
    loancenter.createEmptyPerson = createEmptyPerson;
    function createPerson() {
        var firstName = getFirstName(), middle = getMiddleIntial(), last = getLastName(), phoneNumbers = [];
...
//# sourceMappingURL=loanparticipants.viewmodel.js.map