...
(function () {
    ...
    function config($stateProvider) {
        $stateProvider.state('loanCenter.workbench', {
            'abstract': true,
            url: 'workbench',
            views: {
                'workbench': {
            ...
            resolve: {
                wrappedLoan: function (mailroomResolver, docVaultResolver, docVaultSvc, loanService, $stateParams, HttpUIStatusService, BroadcastSvc, applicationData, $filter, $q) {
                    var d = $q.defer();
                    mailroomResolver(docVaultResolver, docVaultSvc, loanService, $stateParams, HttpUIStatusService, BroadcastSvc, applicationData, $filter, $q).then(function (data) {
                        d.resolve(data);
                    });
                    return d.promise;
                }
...
//# sourceMappingURL=mailroom.routes.js.map