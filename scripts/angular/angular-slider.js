...
(function () {
    ...
    sliderDirective = function ($timeout) {
        return {
            ...
            template: '<span class="bar1"></span><span class="bar1 selection1"></span><span class="pointer1"></span><span class="pointer1"></span><span class="bubble1 selection1"></span><span ng-bind-html-unsafe="translate({value: floor})" class="bubble1 limit1"></span><span ng-bind-html-unsafe="translate({value: ceiling})" class="bubble1 limit1"></span><span class="bubble1"></span><span class="bubble1"></span><span class="bubble1"></span>',
